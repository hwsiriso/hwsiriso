...
class GameScene {
  ...
  preload() {
      ...
      this.load.tilemapTiledJSON('map','assets/test4.json');
      this.load.image('tileset','assets/ancient-final-greek.jpg');
      this.load.image('back','assets/parthenon3.jpg');      
	  
  }

  create() {
 	  
      let baggrund=this.add.image(500,340,'back').setPosition(250,170);
...
//});
    ...
    createWorld(){
      ...
      const tileset = this.map.addTilesetImage('ancient-final-greek','tileset');
